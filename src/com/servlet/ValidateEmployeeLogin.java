...
import webApp.Employee;
import webApp.Vehicle;

@WebServlet("/ValidateEmployeeLogin")

public class ValidateEmployeeLogin extends HttpServlet {
	
	private static final long serialVersionUID = 1L;
       
	
    public ValidateEmployeeLogin() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Vehicle car4 = new Vehicle("K3R0F8G8GK5M5KJT0", "MINI", "Mini Cooper", 2012, 64000, 26250, true, "2018-02-26", "./Images/car4.jpg");
	    ...
	    Employee emp1 = new Employee("Brett", "Thomas");
		...
		if (employee.validateLogin(fName, lName, code)) {
			employee = employee.findUser(fName, lName);
