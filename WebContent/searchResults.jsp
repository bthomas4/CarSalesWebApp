<%@ page language="java" import="java.util.Set" import="java.util.HashSet" import="webApp.User" import="webApp.Vehicle" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<% User user = (User)session.getAttribute("user"); %>
<% Set<Vehicle> searchResults = (HashSet<Vehicle>)session.getAttribute("searchResults"); %>
...
<div>
<c:choose>
<c:when test="${empty searchResults}"><p class="text-center" id="white">No search results found...</p></c:when>
<c:when test="${searchResults!=null}">
	<c:forEach items="${searchResults}" var="vehicle">
	<table class="mytable">
		<tbody>
			<tr class="mytr">
				<td>
...
<c:otherwise><p class="text-center" id="white">No search results found...</p></c:otherwise>
</c:choose>
</div>

<p id="space2"></p>
<footer>
	<p class="text-center" id="white"><a href="./main.jsp">Home</a></p>
